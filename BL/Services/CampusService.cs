...
namespace Application.Services
{
    ...
    {
        public CampusService(IBaseRepo<Campus> iBaseRepo, IBaseRepo<Campus> iBaseDetailRepo, IUnitOfWork iUnitOfWork, IMapper iMapper, IMemoryCache iMemoryCache) : base(iBaseRepo, iBaseDetailRepo, iUnitOfWork, iMapper, iMemoryCache)
        {
        }
